          ...
          <div className="container mx-auto">
            <div className="footer-top flex flex-wrap justify-between mb-6 gap-15">
              ...
              <div className="w-auto">
                ...
                <ul>
                  <li><a href="https://www.linkedin.com/company/msai-studio/" target='_blank' className="mb-2 text-lg hover:text-[#00C0FF]"><Image className='mr-2' src="/icon/linkedin.svg" alt="linkedin" width={24} height={24} />Linkedin</a></li>
                  <li><a href="https://www.youtube.com/@MSAI-personaldesign"  target='_blank' className="mb-2 text-lg hover:text-[#00C0FF]"> <Image className='mr-2' src="/icon/youtube.svg" alt="youtube" width={24} height={24} />YouTube</a></li>
                  <li><a href="https://www.instagram.com/msai_design/"  target='_blank' className="mb-2 text-lg hover:text-[#00C0FF]"><Image className='mr-2' src="/icon/instagram.svg" alt="instagram" width={24} height={24} />Instagram</a></li>
                </ul>
              </div>
              <div className="w-auto">

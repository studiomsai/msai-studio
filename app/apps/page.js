...
export default function Apps() {
  const apps = [
    ...
    {id: 'Imgvideo', name: 'Expression Images & Video', cost: 32, icon: '🎬', desc: 'Turn text into cinematic video. Write a script and watch it come to life in seconds.', link: '/expressions-5-images-20sec-video'},
    {id: 'Imagination', name: 'Popcorn on Steroids', cost: 32, icon: '🎬', desc: 'Turn text into cinematic video. Write a script and watch it come to life in seconds.', link: '/popcorn-on-steroids'}
  ]

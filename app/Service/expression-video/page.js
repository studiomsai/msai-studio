    ...
    <div className="dashboard-container container mx-auto">
      <div className="dashboard-card">
       ...
       Expression Video
        ...
        <p className="credits-text"><strong>Note:</strong> Minimum  <span className="text-green-500">50 credits </span>requireed</p>
        ...
        <div className="file-input-container">
          ...
          <input
            ...
            className="file-input" id="expression-video"
          />
          {!preview && <label htmlFor="expression-video">Choose Image</label>}
          {preview && (

...
export default function DashboardPage() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      const res = await fetch("/api/run-fal-caricature-video", {
        method: "POST",
  ...
  return (
    <div className="dashboard-container container mx-auto">
      <div className="dashboard-card">
        ...
        <p className="credits-text"><strong>Note:</strong> Minimum  <span className="text-green-500">20 credits </span>requireed</p>
        ...
        <div className="file-input-container">
          ...
          />
          {!preview && <label htmlFor="caricature">Choose Image</label>}
          {preview && (
                      ...
                      {result.output?.images?.[0]?.url && (
                        <div className="media-item">
                          ...
                          <div className="relative group">
                            ...
                            />
                            <div className="absolute top-2 right-2 cursor-pointer bg-black p-3 rounded mr-1 download-btn" onClick={() => handleDownload(result.output.images[0].url, 'caricature-image.jpg')}>
                      ...
                      {result.output?.video?.url && (
                        <div className="media-item">
                          ...
                          <div className="relative group">
                            ...
                            />
                            <div className="absolute top-2 right-2 cursor-pointer bg-black p-3 rounded mr-1 download-btn z-10" onClick={() => handleDownload(result.output.video.url, 'caricature-video.mp4')}>
                              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M21 15V19C21 19.5304 20.7893 20.0391 20.4142 20.4142C20.0391 20.7893 19.5304 21 19 21H5C4.46957 21 3.96086 20.7893 3.58579 20.4142C3.21071 20.0391 3 19.5304 3 19V15" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                                <path d="M7 10L12 15L17 10" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                                <path d="M12 15V3" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>

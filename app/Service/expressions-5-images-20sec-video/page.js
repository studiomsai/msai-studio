...
export default function DashboardPage() {
  ...
  const handleGenerate = async () => {
    ...
    if (credit < 70) return alert("Insufficient credits");
    ...
    try {
      ...
      const res = await fetch("/api/run-fal-expressions-5-images-20sec-video", {
        method: "POST",
  ...
  return (
    <div className="dashboard-container container mx-auto">
      ...
      <div className="dashboard-card"> <h1 className="text-2xl md:text-4xl font-medium mb-8 sub-title left-title w-full">
        ...
        <p className="credits-text"><strong>Note:</strong> Minimum  <span className="text-green-500">70 credits </span>required</p>

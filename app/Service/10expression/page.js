    ...
    <div className="dashboard-container container mx-auto">
      ...
      <h1 className="text-2xl md:text-4xl font-medium mb-8 sub-title left-title w-full">
        ...
        <div className="file-input-container">
          ...
          />
          {!preview && <label htmlFor="expression">Choose Image</label>}
          {preview && (
            ...
            <div className="media-grid">
              {result.output?.images?.[0]?.url && (
                <div className="media-item">
                  ...
                  <div className="flex flex-wrap gap-4 expression-group">
                     ...
                     <div className="relative group">
                       <Image src={result.output.images_7[0].url} alt="Generated Image" className="expression-image" width={200} height={200} unoptimized={true}
                            priority={true}
                            onError={() => console.error("Failed to load generated image")}/>
